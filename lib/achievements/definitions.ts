...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  },
  {
    id: "calendar_sync",
    emoji: "📅",
    titleEn: "Calendar Master",
    titleRu: "Мастер календаря",
    descriptionEn: "Sync a task with your calendar",
    descriptionRu: "Синхронизируйте задачу с календарём",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "common",
  },
  {
    id: "matrix_explorer",
    emoji: "🗺️",
    titleEn: "Matrix Explorer",
    titleRu: "Исследователь матрицы",
    descriptionEn: "View the Eisenhower Matrix",
    descriptionRu: "Посмотрите матрицу Эйзенхауэра",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "common",
  },
  {
    id: "kanban_master",
    emoji: "📊",
    titleEn: "Kanban Master",
    titleRu: "Мастер Канбан",
    descriptionEn: "Use the Kanban board view",
    descriptionRu: "Используйте представление доски Канбан",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "common",
  },
  {
    id: "theme_collector",
    emoji: "🎨",
    titleEn: "Theme Collector",
    titleRu: "Коллекционер тем",
    descriptionEn: "Try all available themes",
    descriptionRu: "Попробуйте все доступные темы",
    conditionType: "custom",
    conditionValue: 4,
    rarity: "rare",
  },
  {
    id: "thousand_done",
    emoji: "🌌",
    titleEn: "Infinity Master",
    titleRu: "Мастер бесконечности",
    descriptionEn: "Complete 1000 tasks",
    descriptionRu: "Выполните 1000 задач",
    conditionType: "tasks_completed_total",
    conditionValue: 1000,
    rarity: "legendary",
  },
