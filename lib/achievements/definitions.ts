...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  // --- Row 9: Unlock Emojis (special rewards) ---
  {
    id: "kanban_master",
    emoji: "📌",
    titleEn: "Kanban Master",
    titleRu: "Мастер Канбана",
    descriptionEn: "Create 3 custom columns in Kanban board",
    descriptionRu: "Создайте 3 пользовательских столбца в Канбане",
    conditionType: "custom",
    conditionValue: 3,
    rarity: "rare",
  },
  {
    id: "matrix_navigator",
    emoji: "🗺️",
    titleEn: "Matrix Navigator",
    titleRu: "Навигатор матрицы",
    descriptionEn: "Move a task between quadrants 5 times",
    descriptionRu: "Переместите задачу между квадрантами 5 раз",
    conditionType: "custom",
    conditionValue: 5,
    rarity: "rare",
  },
  {
    id: "deadline_hunter",
    emoji: "⏳",
    titleEn: "Deadline Hunter",
    titleRu: "Охотник за дедлайнами",
    descriptionEn: "Complete 10 tasks before their deadline",
    descriptionRu: "Выполните 10 задач до дедлайна",
    conditionType: "custom",
    conditionValue: 10,
    rarity: "epic",
  },
  {
    id: "theme_explorer",
    emoji: "🎨",
    titleEn: "Theme Explorer",
    titleRu: "Исследователь тем",
    descriptionEn: "Try all available themes in settings",
    descriptionRu: "Попробуйте все доступные темы в настройках",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "rare",
  },
  {
    ...
    titleRu: "Полиглот",
    descriptionEn: "Switch app language at least once",
    descriptionRu: "Переключите язык приложения хотя бы раз",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "common",
  },
  {
    ...
    titleRu: "Путешественник во времени",
    descriptionEn: "Set a task deadline more than 1 year in the future",
    descriptionRu: "Установите дедлайн задачи более чем через год",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "rare",
  },
  {
    ...
    titleRu: "Король возвращений",
    descriptionEn: "Restore a task from the trash",
    descriptionRu: "Восстановите задачу из корзины",
    conditionType: "custom",
    conditionValue: 1,
    rarity: "common",
  },
  {
    ...
    emoji: "🌙",
    titleEn: "Night Shift",
    titleRu: "Ночная смена",
    descriptionEn: "Complete 5 tasks between 10 PM and midnight",
    descriptionRu: "Выполните 5 задач между 22:00 и полуночью",
    conditionType: "secret",
    conditionValue: 5,
    rarity: "rare",
  },
